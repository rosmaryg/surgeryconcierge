...
def genCalendar():
  ...
  if ret_val == 0:
    return 'Calendar succesfully created!   <a href="http://google.com/calendar">View my calendar</a> <br><br> <button onClick=\"window.close()\"">Close this window and get PDF</button>'
  else:
